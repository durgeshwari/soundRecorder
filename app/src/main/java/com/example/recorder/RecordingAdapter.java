...
public class RecordingAdapter extends RecyclerView.Adapter<RecordingAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_tab2,parent,false);
    ...
    private void setUpData(ViewHolder holder, int position) {
        ...
        if( recording.isPlaying() ){
            holder.imageViewPlay.setImageResource(R.drawable.ic_stop_black_24dp);
            TransitionManager.beginDelayedTransition((ViewGroup) holder.itemView);
            holder.seekBar.setVisibility(View.VISIBLE);
            holder.seekUpdation(holder);
        }else{
            holder.imageViewPlay.setImageResource(R.drawable.ic_play_circle_outline_black_24dp);
            TransitionManager.beginDelayedTransition((ViewGroup) holder.itemView);
